...
$string['persistent_help'] = 'Persistent connections may improve performance in heavy traffic environments.';
$string['persistentid'] = 'Persistent connection ID';
$string['persistentid_help'] = 'Persistent connections are usually unique only for the server\'s <code>host:port</code> combination. If your configuration will open multiple connections to the server with different configurations (e.g. accessing different Redis databases) you\'ll need to create unique connection IDs for each.';
$string['timeout'] = 'Operation timeout';
$string['timeout_help'] = 'The timeout for Redis operations (decimal; in seconds).';
